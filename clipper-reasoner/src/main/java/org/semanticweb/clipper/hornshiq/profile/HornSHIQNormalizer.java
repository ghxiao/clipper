...
//		throw new IllegalArgumentException(axiom.toString());
    ...
    public void visit(OWLClassAssertionAxiom axiom) {
        ...
        if (cls.isAnonymous()) {
            OWLClass freshClass = getFreshClass(cls);
            factory.getOWLSubClassOfAxiom(freshClass, cls).accept(this);
            manager.addAxiom(normalizedOnt, factory.getOWLClassAssertionAxiom(freshClass, axiom.getIndividual()));
        } else {
            manager.addAxiom(normalizedOnt, axiom);
        }
    }
    ...
    public void visit(OWLEquivalentClassesAxiom axiom) {
        axiom.asOWLSubClassOfAxioms().forEach(ax -> ax.accept(this));
    }
