...
public class ClipperAtomSubAllAxiom implements ClipperTBoxAxiom {
    ...
    public ClipperAtomSubAllAxiom(int concept1, int role, int concept2) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ClipperAtomSubAllAxiom)) return false;
        final ClipperAtomSubAllAxiom other = (ClipperAtomSubAllAxiom) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ClipperAtomSubAllAxiom;
    }
}
