...
public class NewTBoxReasoner {
    ...
    private void initOntology(ClipperHornSHIQOntology ont_bs) {
        ...
        this.forwardPropagation = new HashSet<ClipperOverAproxPropagation>();
        this.backwardPropagation= new HashSet<ClipperOverAproxPropagation>();
    ...
    public NewTBoxReasoner(ClipperHornSHIQOntology ont_bs) {
        initOntology(ont_bs);
    }

    public NewTBoxReasoner(ClipperHornSHIQOntology ont_bs, Collection<Set<Integer>> initAxiomEnablers) {
        initOntology(ont_bs);
