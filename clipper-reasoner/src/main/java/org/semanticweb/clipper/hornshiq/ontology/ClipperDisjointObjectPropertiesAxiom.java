...
public class ClipperDisjointObjectPropertiesAxiom implements ClipperTBoxAxiom {
    ...
    public ClipperDisjointObjectPropertiesAxiom(int role1, int role2) {
        this.role1 = role1;
        this.role2 = role2;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ClipperDisjointObjectPropertiesAxiom)) return false;
        final ClipperDisjointObjectPropertiesAxiom other = (ClipperDisjointObjectPropertiesAxiom) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ClipperDisjointObjectPropertiesAxiom;
    }
}
