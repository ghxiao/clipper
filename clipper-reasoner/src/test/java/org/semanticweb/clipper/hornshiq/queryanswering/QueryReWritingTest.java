...
public class QueryReWritingTest {
	...
	// List<InversePropertyOfAxiom> inversePropertyOfAxioms = new
	// ArrayList<InversePropertyOfAxiom>();
	...
	public void test() {
		...
		for(int index = 0; index <= totalCount; index++){
			System.out.println(index + "-> " + toIndex(counts, index));
		}
	}

	List<Integer> toIndex(Collection<Integer> counts, int value) {
