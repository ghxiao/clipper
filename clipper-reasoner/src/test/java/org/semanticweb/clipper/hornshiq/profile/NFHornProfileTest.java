...
import org.semanticweb.clipper.hornshiq.profile.NFHornSHIQProfile;
 ...
 */
public class NFHornProfileTest {
	public static void main(String[] args) {
		...
		try {
			...
			// OWLOntology ont =
			// man.loadOntologyFromOntologyDocument(URI.create("http://www.co-ode.org/ontologies/pizza/pizza.owl"));
			// File file = new
			// File("/home/students/kien/MasterProject/TestData/HornSHIQ_NF1.owl");
			...
			check(ont, new NFHornSHIQProfile());
	...
	private static void check(OWLOntology ont, OWLProfile profile) {
		...
		try {
			...
			// FileWriter("/home/students/kien/MasterProject/TestData/HornSHIQPrifile.txt");
