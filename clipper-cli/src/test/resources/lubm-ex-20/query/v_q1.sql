...
(
SELECT 
v_takesCourse_1.att1 AS att1 , v_teacherOf_1.att1 AS att2 
FROM 
...
WHERE 
v_teacherOf_1.att1 = v_worksFor_1.att1
 ...
 AND v_worksFor_1.att2 = v_memberOf_1.att2
...
v_teacherOf_1.att1 = v_worksFor_1.att1
 ...
 AND v_worksFor_1.att2 = v_memberOf_1.att2
 AND v_worksFor_1.att2 = v_Department_1.att1
 AND v_teacherOf_1.att2 = v_takesCourse_1.att2
)
UNION
(
SELECT 
v_Faculty_1.att1 AS att1 , v_Faculty_1.att1 AS att2 
FROM 
v_takesCourse v_takesCourse_1,
v_Faculty v_Faculty_1,
v_Student v_Student_1,
v_teacherOf v_teacherOf_1
WHERE 
v_Faculty_1.att1 = v_takesCourse_1.att1
 AND v_Faculty_1.att1 = v_Student_1.att1
 AND v_Faculty_1.att1 = v_teacherOf_1.att1
...
v_Chair v_Chair_1
WHERE 
v_Faculty_1.att1 = v_Chair_1.att1
 AND v_Faculty_1.att1 = v_takesCourse_1.att1
 AND v_Faculty_1.att1 = v_Student_1.att1
 AND v_Faculty_1.att1 = v_teacherOf_1.att1
 AND v_takesCourse_1.att2 = v_teacherOf_1.att2
)
