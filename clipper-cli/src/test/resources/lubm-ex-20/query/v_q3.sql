...
WHERE 
v_subOrganizationOf_1.att2 = v_degreeFrom_1.att2
 AND v_subOrganizationOf_1.att2 = v_University_1.att1
 AND v_degreeFrom_1.att1 = v_Faculty_1.att1
 AND v_degreeFrom_1.att1 = v_memberOf_1.att1
 AND v_subOrganizationOf_1.att1 = v_memberOf_1.att2
 AND v_subOrganizationOf_1.att1 = v_Department_1.att1
)
UNION
(
SELECT 
